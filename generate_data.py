...
def calculate_next_closing_volume(last_close, close):
    """ Return closing volume

    :param last_close: closing volume of last candle (not necessary)
    :param close: closing volume of candle to predict
    :return: float
    """
    return close
